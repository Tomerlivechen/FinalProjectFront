  ...
  return (
    <ElementFrame tailwind="p-6 max-w-5xl mx-auto">
      ...
      <p className="mb-4">
        ...
        HackerU! This project required developing both the frontend and backend
        for a web app.
      </p>
      <p className="mb-4">
      ...
      <ul className=" mb-4">
        ...
        <li>
          <b>Password Recovery</b>: A secure password recovery solution via the
          Identity framework and EmailJS.
        </li>
        <li>
          <b>Responsiveness</b>: The app is fully responsive and compatible with
          all screen sizes.
        </li>
      </ul>
      <p>
