  ...
  return (
    <>
      <MotionFrame>
        <div>
          <div
            className={`${colors.ActiveText} md:text-5xl text-2xl  font-bold flex justify-center animate-pulse `}
          >
          ...
          <div className="flex flex-wrap justify-center ">
            <img
              className="w-2/3"
              src="https://res.cloudinary.com/dhle9hj3n/image/upload/v1730645901/pyvlixvy8h3ipi1y7trw.jpg"
            />
          </div>
